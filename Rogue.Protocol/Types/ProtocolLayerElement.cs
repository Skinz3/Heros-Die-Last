...
{
    public class ProtocolLayerElement : MessageType
    {
        ...
        public ProtocolLayerElement()
        {

        }
        public ProtocolLayerElement(int cellId, LayerEnum layerEnum, MapObjectType type, string visualData, bool walkable)
        {
            this.CellId = cellId;
